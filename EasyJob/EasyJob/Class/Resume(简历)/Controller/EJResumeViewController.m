...
@interface EJResumeViewController ()

@end

@implementation EJResumeViewController
...
////     判断是不是点击了确定按钮
////        if([indexPath.row isEqualToString:@"conform"] && indexPath.row == XLFormRowDescriptorTypeButton){
////
////            //获取表单所有到的值
////            NSDictionary *values =  [self formValues];
////
